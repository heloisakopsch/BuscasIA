...
public class IATrabalho1 implements Estado {
	...
	public static void main(String[] args) {
		...
		Disciplina disciplina1 = new Disciplina("A",disciplinaA1, Horario.SEG_18_20, Horario.SEG_20_22);
		Disciplina disciplina2 = new Disciplina("B",disciplinaB2, Horario.TER_18_20, Horario.TER_20_22);
		Disciplina disciplina3 = new Disciplina("C",disciplinaC3, Horario.QUA_18_20, Horario.QUA_20_22);
		Disciplina disciplina4 = new Disciplina("D", disciplinaD4, Horario.QUI_18_20, Horario.QUI_20_22);
		Disciplina disciplina5 = new Disciplina("E",disciplinaE5, Horario.SEX_18_20, Horario.SEX_20_22);
		...
		IATrabalho1 problema = new IATrabalho1(disciplinas, disciplinasAprovadas);	
        ...
        //Nodo s = new BuscaIterativo(new MostraStatusConsole()).busca(problema);
        //Nodo s = new BuscaProfundidade(25,new MostraStatusConsole()).busca(problema);
        //Nodo s = new BuscaBidirecional(new MostraStatusConsole()).busca(problema, getEstadoMeta());
        if (s != null) {
	...
	public IATrabalho1(List<Disciplina> disciplinas, List<Disciplina> disciplinasAprovadas) {
		this.disciplinas = disciplinas;
		this.disciplinasAprovadas = disciplinasAprovadas;
	}

	public IATrabalho1(List<Disciplina> disciplinas,  List<Disciplina> disciplinasAprovadas, String[] grade) {
		this.disciplinas = disciplinas;
		this.disciplinasAprovadas = disciplinasAprovadas;
		this.grade = grade;
	}
	...
	private void adicionaDisciplina(List<Estado> suc, int posicao) {
			...
			IATrabalho1 estadoNovo = new IATrabalho1(disciplinas, disciplinasAprovadas, grade.toArray(new String[this.grade.length]));
